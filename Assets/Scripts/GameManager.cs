...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] int numberOfTurrets = 15;
    ...
    [SerializeField] int numberOfPowerUp = 5;

    [SerializeField][Range(0.1f, 50f)] private float minDistancePowerUpX = 1;
    [SerializeField][Range(0.1f, 50f)] private float minDistancePowerUpZ = 5;

    [SerializeField][Range(0.1f, 100f)] private float deltaPowerUpX = 1;
    [SerializeField][Range(0.1f, 100f)] private float deltaPowerUpZ = 1;
    #endregion
    ...
    void Start()
    {
        ...
        {
            GameObject powerUp = Instantiate(powerUpPreFab[Random.Range(0, powerUpPreFab.Length)]);

            powerUp.transform.position = powerUp.transform.position + new Vector3(
            minDistancePowerUpX + Random.Range(-1f, 1f) * deltaPowerUpX,
            powerUp.transform.localScale.y,
            minDistancePowerUpZ + Random.Range(-1f, 1f) * deltaPowerUpZ);
